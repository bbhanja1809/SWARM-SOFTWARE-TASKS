...
cap = cv2.VideoCapture('Level 3.mp4')#same for Level 2.mp4 and Level 1.mp4
frameTime = 12
frame_width = int(cap.get(3))
frame_height = int(cap.get(4))
fps = cap.get(cv2.CAP_PROP_FPS)
size = (frame_width,frame_height)
result = cv2.VideoWriter('Level3.avi', cv2.VideoWriter_fourcc(*'MJPG'), fps, size)#same for Level1.avi and Level2.avi
